import 'package:apkbab3/screen/cart_page.dart';
// import 'package:apkbab3/screen/pilihan.dart';
// import 'package:apkbab3/screen/fashion_page.dart';
  ...
  Widget build(BuildContext context) {
    return const Column(
      children: [
        ...
        ServiceCard(
          imageUrl: 'assets/images/prili.jpg',
          name: 'Miss Zachary Will',
          role: 'Beautician',
          description: 'Doloribus saepe aut necessitatibus qui.',
          rating: 4.9,
...
class BestBooking2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Column(
        children: [
          BestBookingCard(
            imageUrl: 'assets/images/Picture3.png',
            ...
            child: Row(
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      const Icon(Icons.star, color: Color.fromARGB(255, 56, 104, 216), size: 16),
                      const SizedBox(width: 4),
                      Text(
                        rating.toString(),
                        style: const TextStyle(
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: const Row(
                      children: [
                        Icon(Icons.star, color: Color.fromARGB(255, 75, 88, 232), size: 16),
                        SizedBox(width: 4),
                        Text(
                          "4.9",
                          style: TextStyle(
